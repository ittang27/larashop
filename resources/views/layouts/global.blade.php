...
<body>
    ...
    <nav class="navbar navbar-expand p-0">
     <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="/larashop/home"><span class="oi oi-cloudy"></span> Larashop </a>
    ...
    <div style="min-height: 100%" class="flex-row d-flex align-items-stretch m-0">
        <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
            ...
            <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
              ...
              <li><a href="{{route('categories.index')}}"><span class="oi oi-laptop"></span> Cateogries </a></li>
              <li><a href="#"><span class="oi oi-book"></span> Book </a></li>
              <li><a href="#"><span class="oi oi-random"></span> Order </a></li>
              <li><a href="#"><span class="oi oi-chevron-right"></span> Reporting </a></li>
              <li><a href="#"><span class="oi oi-account-logout"></span> Logout </a></li>
